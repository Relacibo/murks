...
- [x] **Desktop: Flow-Name-Klick blendet Übersicht ein** — klickt man im Desktop-Modus auf einen Flow-Namen und die Übersicht (Flow-Spalten) ist ausgeblendet, muss sie eingeblendet werden.
